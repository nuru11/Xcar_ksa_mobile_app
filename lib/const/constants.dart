...
const int specialOffersID = 26;
const int bestSellingId = 26;
const int trendingProductsId = 26;
const int newArrive = 26;
const int recommendedProductId = 26;
const String currencySign = '\SAR';
const String shippingCountry = 'India';


//const kPrimaryColor = Color(0xFFFF7F00);
// const kPrimaryColor = Color(0xFF000080);
const kPrimaryColor = Color(0xFFF57328);
