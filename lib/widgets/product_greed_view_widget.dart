                ...
                widget.singleProductVariations != null
                    ? MyGoogleText(
                        text: widget.singleProductVariations!.salePrice
                                    .toInt() <=
                                0
                            ? '\SAR ${widget.singleProductVariations!.regularPrice}'
                            : '\SAR ${widget.singleProductVariations!.salePrice}',
                        fontSize: 14,
                    ...
                    : MyGoogleText(
                        text: widget.productModel.salePrice.toInt() <= 0
                            ? '\SAR ${widget.productModel.regularPrice}'
                            : '\SAR ${widget.productModel.salePrice}',
                        fontSize: 14,
                        fontColor: isDark ? darkTitleColor : lightTitleColor,
                        fontWeight: FontWeight.normal,
                      ),
