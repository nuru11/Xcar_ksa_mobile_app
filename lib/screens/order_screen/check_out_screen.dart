                                ...
                                children: [
                                                                ...
                                                                children: [
                                                                  Expanded(
                                                                    child: SingleChildScrollView(
                                                                      scrollDirection: Axis.horizontal,
                                                                      child: MyGoogleText(
                                                                        text: '${cart.cartOtherInfoList[index].productPrice}\SAR',
                                                                        fontSize: 16,
                                                                        fontColor: isDark ? darkTitleColor : lightTitleColor,
                                                                        fontWeight: FontWeight.normal,
                                                                      ),
                                  ...
                                  Material(
                                    ...
                                    shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'Paypal' ? kPrimaryColor : isDark?darkContainer:secondaryColor3)),
                                  ...
                                  Material(
                                    elevation: 0.0,
                                    shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'Stripe' ? kPrimaryColor : isDark?darkContainer:secondaryColor3)),
                                    color: isDark ? darkContainer : Colors.white,
                                    child: CheckboxListTile(
                                  ...
                                  Material(
                                    elevation: 0.0,
                                    shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'Tap' ? primaryColor : isDark?darkContainer:secondaryColor3)),
                                    color: isDark?darkContainer:Colors.white,
                                    child: CheckboxListTile(
                                  ...
                                  Material(
                                    elevation: 0.0,
                                    shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'Paytm' ? kPrimaryColor : isDark?darkContainer:secondaryColor3)),
                                    color: isDark ? darkContainer : Colors.white,
                                    child: CheckboxListTile(
                                                  ...
                                                  Consumer(builder: (_, ref, __) {
                                                    ...
                                                    return MyGoogleText(
                                                      text: widget.couponPrice == null
                                                          ? '\SAR${(price.cartTotalPriceF(initialValue)).toStringAsFixed(2)}'
                                                          : '\SAR${(price.cartTotalPriceF(initialValue) - price.promoPrice).toStringAsFixed(2)}',
                                                      fontSize: 20,
                                                      fontColor: isDark ? darkTitleColor : lightTitleColor,
                                                      fontWeight: FontWeight.normal,
                                                    );
