...
class _CartScreenState extends State<CartScreen> {
  ...
  child: SingleChildScrollView(
    ...
    child: MyGoogleText(
      text: '\SAR${cart.cartOtherInfoList[index].productPrice}',
      fontSize: 16,
      fontColor: isDark ? darkTitleColor : lightTitleColor,
      fontWeight: FontWeight.normal,
    ),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Consumer(builder: (_, ref, __) {
                          final price = ref.watch(cartNotifier);
                          return MyGoogleText(
                            text: '\SAR ${price.cartTotalPriceF(initialValue).toStringAsFixed(2)}',
                            fontSize: 20,
                            fontColor: isDark ? darkTitleColor : lightTitleColor,
                            fontWeight: FontWeight.normal,
                          );
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        !isCouponApply
                          ...
                          final price = ref.watch(cartNotifier);
                          return MyGoogleText(
                            text: '\SAR ${(price.cartTotalPriceF(initialValue) - price.promoPrice).toStringAsFixed(2)}',
                            fontSize: 20,
                            fontColor: isDark ? darkTitleColor : lightTitleColor,
                            fontWeight: FontWeight.normal,
                          );
