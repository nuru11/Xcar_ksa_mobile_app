...
class _SingleCategoryScreenState extends State<SingleCategoryScreen> {
  ...
  Future<void> _refreshData() async {
    ...
    // For example, you can make an API call to fetch new data
   

    // After fetching new data, rebuild the widget to reflect the changes
    setState(() {});
  }
                              ...
                              if (filterDataModel.isFiltered) {
                                ...
                                return GridView.builder(
                                 ...
                                 // itemCount: snapshot.length,
                                   itemCount: snapshot.length > addproduct ? addproduct : snapshot.length,
                                  itemBuilder: (BuildContext ctx, index) {
...
//     // Add listener to check if user reached the bottom of the screen
//     _scrollController.addListener(_scrollListener);
//   }
...
// class _ScrollableWidgetState extends State<SingleCategoryScreen> {
//   ScrollController _scrollController = ScrollController();
//   List<String> _dummyData = List.generate(100, (index) => 'Item $index');
