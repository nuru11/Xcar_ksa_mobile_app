...
// import 'package:maanstore/screens/dummy_products.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String selectedWidth = '33';
  List<String> widthOptions = ['33', '35', '72', '22'];
 ...
 // List<String> exclusiveName = ['Women', 'Cosmetics', 'Men', 'Kids'];
  ...
  backgroundColor: Color(0xFFF57328),
  onPressed: () {
            ...
            title: Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(borderSide: const BorderSide(color: Color(0xFFF57328)), borderRadius: BorderRadius.circular(30)),
                    enabledBorder: OutlineInputBorder(borderSide: const BorderSide(color: Color(0xFFF57328)), borderRadius: BorderRadius.circular(30)),
                    hintText: 'Search',
 ...
 Padding(
  ...
  child: SizedBox(
    ...
    child: ElevatedButton(
      ...
      style: ButtonStyle(
        backgroundColor: MaterialStateProperty.all(Color(0xFFF57328)),
      ),
      child: Text(
        "Sign Up",
        style: TextStyle(color: Colors.white),
          ...
          body: SingleChildScrollView(
            ...
            //     },
            //     style: ElevatedButton.styleFrom(
            //       // backgroundColor: Color(0xFFf00202), // Set background color to red
            //       backgroundColor: Color(0xFFF50707),
            //     ),
            //     child: Text('Find Your Dream Car', style: TextStyle(color: Colors.white,),),
            //   ),
            // ),
...
Padding(
  ...
  child: allBanner.when(
    data: (snapShot) {
      ...
      //   ),
      //   child: Image.asset("images/7.png", fit: BoxFit.cover),
      // ),
      ...
      Container(
       ...
       Container(
        ...
        child: Image.asset("images/9.png", fit: BoxFit.cover),
      ),
      ...
      //     borderRadius: BorderRadius.circular(10),
      //   ),
      //   child: Image.asset("images/slider-3_c.png", fit: BoxFit.cover),
      // ),
...
//                  color: Color.fromARGB(255, 4, 107, 148),
...
//   ),
                                       ...
                                       Stack(
                                        ...
                                        children: [
                                          Image.asset(
                                            'images/bc2.png',
                                            width: 180,
                                            color: isDark ? darkContainer : Color(0xFFF57328),
                                          ),
                                          Text(
                                               ...
                                               children: [
                                                ...
                                                //          ),
                                                 ...
                                                 Padding(
                                                   ...
                                                   child: MyGoogleText(
                                                     text: snapShot[index].type == 'simple' ? '\SAR ${snapShot[index].salePrice}' : '\SAR ${snapData[0].salePrice}',
                                                     fontSize: 14,
                                                     fontColor: isDark ? darkTitleColor : lightTitleColor,
                                                 ...
                                                 Padding(
                                                   ...
                                                   child: MyGoogleText(
                                                     text: snapShot[index].type == 'simple'
                                                         ...
                                                         ? '\SAR ${snapShot[index].regularPrice}'
                                                         : '\SAR ${snapShot[index].salePrice}'
                                                         : snapData[0].salePrice!.toInt() <= 0
                                                         ? '\SAR ${snapData[0].regularPrice}'
                                                         : '\SAR ${snapData[0].salePrice}',
                                                     fontSize: 14,
                                                     fontColor: isDark ? darkTitleColor : lightTitleColor,
                                                     fontWeight: FontWeight.w600,
                                                   ),
 ...
 Widget _buildCategoryList(List<CategoryModel> categories) {
    ...
    for (var element in categories) {
      if (element.parent == 0 && element.id! != 25 && element.id! >= 25 && element.id! <= 38) {
 ...
 Widget _buildCategoryList3(List<CategoryModel> categories) {
  final List<CategoryModel> finalList = [];
  for (var element in categories) {
    if (element.parent == 0 && element.id! >= 40 && element.id! <= 48) {
      finalList.length < 9 ? finalList.add(element) : null;
    }
  }
...
void _showPopupForm(BuildContext context) {
  ...
  onPressed: () {
    Navigator.of(context).pop();
    Navigator.pushNamed(context, '/dummy_products');
  },
  child: Text('Search'),
),
          ],
